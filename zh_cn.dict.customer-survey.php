...
Dict::Add('ZH CN', 'Chinese', '简体中文', array(
	...
	'Class:SurveyTargetAnswer' => '调查对象回答',
	...
	'Class:SurveyTargetAnswer/Attribute:date_response' => '回答日期',
	'Class:SurveyTargetAnswer/Attribute:token' => '匿名化令牌',
	'Class:SurveyTargetAnswer/Attribute:survey_id' => '调查',
	'Class:SurveyTargetAnswer/Attribute:last_question_id' => '回答的最后一个问题',
	...
	'Survey-results-noanswer' => '当前尚无答复.',
	'Survey-results-X_NonEmptyValuesOutOf_N' => '总计%2$d中的%1$d个非空答复',
	'Survey-results-completion_X_out_of_Y_Percent' => '总计%2$d中的%1$d个人员已答复 (%3$s %% 完成)~~',
	...
	'Survey-CompletionNotificationSubject_name' => '有一份答复来自匿名调查%1$s',
	'Survey-CompletionNotificationBody_url' => '此匿名调查: %1$s刚刚收到一份答复',
	'Survey-CompletionNotificationSubject_name_contact' => '%2$s刚刚答复了此调查%1$s',
	'Survey-CompletionNotificationBody_url_contact' => '%2$s完成了此调查: %1$s',
	'Survey-SurveyFinished' => '此调查已关闭. 不再接收答复.',
...
Dict::Add('ZH CN', 'Chinese', '简体中文', array(
	...
	'Class:SurveyAnswer/Attribute:question_id_finalclass_recall' => '问题终类',
...
Dict::Add('ZH CN', 'Chinese', '简体中文', array(
	...
	'Class:Survey/Attribute:survey_target_answer_list' => '调查对象回答列表',
	'Class:Survey/Attribute:survey_target_answer_list+' => '~~',
	'Class:Survey/Attribute:on_behalf_of_finalclass_recall' => '代表finalclass recall~~',
	'Class:Survey/Attribute:on_behalf_of_finalclass_recall+' => '~~',
	'Class:Survey/Attribute:on_behalf_of_obsolescence_flag' => '代表废弃标记',
...
Dict::Add('ZH CN', 'Chinese', '简体中文', array(
	'Class:SurveyTarget/Attribute:contact_id_finalclass_recall' => '联系人终类',
...
Dict::Add('ZH CN', 'Chinese', '简体中文', array(
	'Class:SurveyTargetAnswer/Attribute:contact_id_finalclass_recall' => '联系人终类',
	...
	'Class:SurveyTargetAnswer/Attribute:last_question_id_finalclass_recall' => '最后问题终类',
